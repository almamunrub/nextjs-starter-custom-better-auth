...
const httpGet = async <TData>(
  ...
  try {
    ...
    normalizeError(endpoint, 'GET', error)
  }
}
...
const httpPost = async <TData>(
  ...
  try {
    ...
    normalizeError(endpoint, 'POST', error)
  }
}
...
const httpPut = async <TData>(
  ...
  try {
    ...
    normalizeError(endpoint, 'PUT', error)
  }
}
...
const httpPatch = async <TData>(
  ...
  try {
    ...
    normalizeError(endpoint, 'PATCH', error)
  }
}
...
const httpDelete = async <TData>(
  ...
  try {
    ...
    normalizeError(endpoint, 'DELETE', error)
  }
}
